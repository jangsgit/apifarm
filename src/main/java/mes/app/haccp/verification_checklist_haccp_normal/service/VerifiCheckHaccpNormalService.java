package mes.app.haccp.verification_checklist_haccp_normal.service;
...
@Service
public class VerifiCheckHaccpNormalService {

	@Autowired
	SqlRunner sqlRunner;

	// 결재현황 조회
	public List<Map<String, Object>> getVerifiCheckHaccpNormalApprStatus(String startDate, String endDate, String apprState, String verifiType) {

		MapSqlParameterSource paramMap = new MapSqlParameterSource();
		paramMap.addValue("startDate", startDate);
		paramMap.addValue("endDate", endDate);
		paramMap.addValue("apprState", apprState);
		paramMap.addValue("verifiType", verifiType);
		...
		String sql = """
				...
				where b."TableName" = 'verification_checklist_haccp_normal'
		...
		if (!verifiType.isEmpty() && verifiType != null) {
            	sql += " and b.\"Text1\" = :verifiType ";
		}
	...
	// 점검표 조회
	public Map<String, Object> getVerifiCheckHaccpNormalList(Integer bh_id) {
	...
	//점검표 삭제
	public void deleteVerifiCheckHaccpNormalList(Integer bhId) {
