package mes.app.haccp.verification_checklist_prerequisites.service;
...
@Service
public class VerifiCheckPrereqService {

	@Autowired
	SqlRunner sqlRunner;

	// 결재현황 조회
	public List<Map<String, Object>> getVerifiCheckPrereqApprStatus(String startDate, String endDate, String apprState) {
		...
		String sql = """
				...
				where b."TableName" = 'verification_checklist_prerequisites'
	...
	// 점검표 조회
	public Map<String, Object> getVerifiCheckPrereqList(Integer bh_id) {
        ...
        if (bh_id > 0) {
            ...
            head_info = this.sqlRunner.getRow(sql, dicParam);
             ...
             sql = """
                ...
                , case ir."Result1" when '해당없음' then true else false end as not_appli
	...
	//점검표 삭제
	public void deleteVerifiCheckPrereqList(Integer bhId) {
