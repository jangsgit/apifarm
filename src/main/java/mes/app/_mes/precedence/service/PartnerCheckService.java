	...
	public Map<String, Object> apprList(Integer bhId, String data_date, Authentication auth) {
		...
		if(bhId > 0) {
		 sql = """
				...
				sql = """
					select tir."CharResult",tir."Char1",tir."Char2",bh."Char1",to_char(bh."Date1",'YYYY-MM-DD')as date1,bh."Text1",
	                ti."Name", to_char(tir."TestDateTime",'YYYY-MM-DD')as testDateTime ,bh."Char2" as necessity,
