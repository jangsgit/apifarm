...
@Service
public class SurfaceBacerialService {
	@Autowired
	SqlRunner sqlRunner;
	...
	public List<Map<String, Object>> getList(String start_date, String end_date) {
		...
		String sql = """
				...
				where b."TableName" = 'surface_bacerial'
	...
	public Map<String, Object> apprList(Integer bhId, String data_date, Authentication auth) {
		...
		if(bhId > 0) {
		 sql = """
	                ...
	                where bh."TableName" = 'surface_bacerial'
	                and bh.id = :bhId
					""";
			...
			head_info.put("id", 0);
			head_info.put("Title", "표면오염도검사 성적서");
		...
		sql = """
				...
				from "devi_action" da
				inner join test_item_result tir on tir.id = da."SourceDataPk" and da."SourceTableName" = 'surface_bacerial'
	...
	public void mstDelete(Integer bhId) {
		...
		String sql = "";
		 ...
		 sql = """
				delete from test_item_result where 1=1 and "SourceTableName" = 'surface_bacerial' and "SourceDataPk" = :bhId
				""";
		
		this.sqlRunner.execute(sql, paramMap);
		
		 sql = """
					delete from test_result where 1=1 and "SourceTableName" = 'surface_bacerial' and "SourceDataPk" = :bhId
					""";
		 ...
		 sql = """
				...
				where 1=1
				and "TableName" = 'surface_bacerial'
				and id = :bhId
				""";
		...
		sql = """
				...
				and tr."SourceTableName" = 'surface_bacerial'
				)
				""";
		this.sqlRunner.execute(sql, paramMap);
