...
public class WaterTestService {
	...
	public Map<String, Object> apprList(Integer bhId, String data_date, Authentication auth) {
		...
		sql = """
				...
				from "devi_action" da
				inner join test_item_result tir on tir.id = da."SourceDataPk" and da."SourceTableName" = 'water_test'
	...
	public void mstDelete(Integer bhId) {
		...
		String sql = "";
		 ...
		 sql = """
				delete from test_item_result where 1=1 and "SourceTableName" = 'water_test' and "SourceDataPk" = :bhId
				""";
		
		this.sqlRunner.execute(sql, paramMap);
		
		sql = """
				delete from test_result where 1=1 and "SourceTableName" = 'water_test' and "SourceDataPk" = :bhId
				""";
